		...
		<div class="container">
			...
			<div id="content_area">
				<div id="left">
					...
					<br />
					<div id="tabela">
						<s:url id="createUrl" action="department-crud!input" />
						<a href="<s:property value="#createUrl" />" class="linknew">Criar Novo Departamento</a>
						<br />
						<br />
						...
						<table class="sofT">
							...
							<s:iterator value="departments" status="status">
								<s:url action="department-crud!input" id="editUrl">
